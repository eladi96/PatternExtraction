...
from sequence_similarity import pos_seq_similarity, trigram_similarity, levenshtein_similairty
...
def build_som():
    ...
    selforgmap = MiniSom(dimension, dimension, EMBEDDING_DIM, sigma=0.3, learning_rate=0.5, activation_distance='cosine')
